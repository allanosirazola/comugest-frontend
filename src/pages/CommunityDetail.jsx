  ...
  return (
    <Layout>
      ...
      <div className="mt-4 flex flex-wrap gap-3">
        ...
        <Link to={`/communities/${community.id}/budget`} className="btn-ghost">
          {t('communities.linkBudget')}
        </Link>
        <Link to={`/communities/${community.id}/areas`} className="btn-ghost">
          {t('communities.linkAreas')}
        </Link>
        <Link to={`/communities/${community.id}/meetings`} className="btn-ghost">
          {t('communities.linkMeetings')}
        </Link>
        ...
        <Link to={`/communities/${community.id}/suppliers`} className="btn-ghost">
          {t('communities.linkSuppliers')}
        </Link>
      ...
      <section className="mt-10">
        <div className="flex items-center justify-between">
          ...
          <button onClick={() => setShowNewUnit((v) => !v)} className="btn-primary">
          ...
          <form onSubmit={handleAddUnit} className="card mt-4">
            <div className="grid gap-3 sm:grid-cols-6">
              ...
              <input
                ...
                value={newUnit.door}
                onChange={(e) => setNewUnit({ ...newUnit, door: e.target.value })}
              />
              <input
