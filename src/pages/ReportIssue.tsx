    ...
    <Layout>
      ...
      <form onSubmit={onSubmit} className="card mt-8 max-w-2xl space-y-5">
        <div>
          ...
          <select id="category" className="input" value={category} onChange={(e): void => setCategory(e.target.value as TicketCategory)}>
        ...
        <div>
          ...
          <textarea id="description" className="input min-h-32" value={description} onChange={(e): void => setDescription(e.target.value)} required placeholder={t('tickets.descriptionPlaceholder')} />
        </div>
