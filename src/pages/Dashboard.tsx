...
function Card({ titleKey, descKey, to, soon }: { titleKey: string; descKey: string; to?: string; soon?: boolean }): JSX.Element {
  const { t } = useTranslation();
  const content = (
    <>
...
function AdminCards(): JSX.Element {
  return (
    <>
...
function VecinoCards(): JSX.Element {
  return (
    <>
